...
//_________________
void readMcDst(const Char_t *inFile = "",
      const Char_t *oFileName = "oProcTest.root",
      const Char_t *oTxtFileName = "oProcTest.txt") {
  ...
  for(Long64_t iEvent=0; iEvent<events2read; iEvent++) {
    ...
    myfile << "Event: " << iEvent << ", Number of charged particles: " << NumOfCharged << "\n";
